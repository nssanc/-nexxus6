...
#define OPTIMAL_POSITION		(7)
#define TABLE_SIZE			(23)
#define HYSTERESIS			(10)
#define UP_THRESH			(100)

static const int valid_fqs[TABLE_SIZE] = {35800, 98300, 300000, 422400, 652800, 729600, 883200, 960000, 1036800, 1190400, 1267200, 1497600, 1574400, 1728000, 1958400, 2265600, 2457600, 2496000, 2572800, 2649600, 2726400, 2803200, 2899000};
